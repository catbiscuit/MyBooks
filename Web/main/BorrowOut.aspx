<%@ Page Title="" Language="C#" MasterPageFile="~/main/MasterPage.Master" AutoEventWireup="true" CodeBehind="BorrowOut.aspx.cs" Inherits="Web.main.BorrowOut" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="100%" align="center">
                        <asp:Button runat="server" ID="btnAdd" Text="借阅" OnClientClick="return btnAdd_Check()" OnClick="btnAdd_Click" />
                    </td>
                </tr>
            </table>
