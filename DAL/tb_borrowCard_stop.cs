...
{
	/// <summary>
	/// 数据访问类:tb_borrowCard_stop
	/// </summary>
	public partial class tb_borrowCard_stop
	{
		public tb_borrowCard_stop()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tb_borrowCard_stop"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tb_borrowCard_stop");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(web.Model.tb_borrowCard_stop model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_borrowCard_stop(");
			strSql.Append("borrow_id,borrow_name,borrow_gender,borrow_card_id,stop_date,relieve_date,operater)");
			...
			parameters[4].Value = model.stop_date;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(web.Model.tb_borrowCard_stop model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_borrowCard_stop set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_borrowCard_stop ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public web.Model.tb_borrowCard_stop GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,borrow_id,borrow_name,borrow_gender,borrow_card_id,stop_date,relieve_date,operater from tb_borrowCard_stop ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			web.Model.tb_borrowCard_stop model=new web.Model.tb_borrowCard_stop();
		...
		/// 得到一个对象实体
		/// </summary>
		public web.Model.tb_borrowCard_stop DataRowToModel(DataRow row)
		{
			web.Model.tb_borrowCard_stop model=new web.Model.tb_borrowCard_stop();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,borrow_id,borrow_name,borrow_gender,borrow_card_id,stop_date,relieve_date,operater ");
			strSql.Append(" FROM tb_borrowCard_stop ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,borrow_id,borrow_name,borrow_gender,borrow_card_id,stop_date,relieve_date,operater ");
			strSql.Append(" FROM tb_borrowCard_stop ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_borrowCard_stop T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_borrowCard_stop";
