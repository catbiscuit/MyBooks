...
namespace web.DAL
{
	...
	public partial class tb_manager
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tb_manager"); 
		}
		...
		public web.Model.tb_manager GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,account,password from tb_manager ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			web.Model.tb_manager model=new web.Model.tb_manager();
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,account,password ");
			strSql.Append(" FROM tb_manager ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
