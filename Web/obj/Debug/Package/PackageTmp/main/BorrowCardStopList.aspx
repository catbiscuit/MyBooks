<%@ Page Title="" Language="C#" MasterPageFile="~/main/MasterPage.Master" AutoEventWireup="true" CodeBehind="BorrowCardStopList.aspx.cs" Inherits="Web.main.BorrowCardStopList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="border: groove; padding: 2px">
        ...
        <asp:Label runat="server" ID="nlblPutinTime">停借时间</asp:Label>
