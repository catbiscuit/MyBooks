...
namespace Web.main
{
    public partial class BorrowCardLostList : System.Web.UI.Page
    {
        //获取web.config中设置的分页
        ...
        private void DataBindToRepeater()
        {
            ...
            string strDate = MyBase.WhereParamBetween(dt1, dt2, "lost_date");
            //创建dic词典对象
            ...
            int recordCount;
            DataSet ds = borrowCardLostBLL.MyGetListByPage(Pager.PageSize, Pager.CurrentPageIndex, string.Empty, sqlWhere, out recordCount);
