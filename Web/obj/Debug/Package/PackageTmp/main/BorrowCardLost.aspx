<%@ Page Title="" Language="C#" MasterPageFile="~/main/MasterPage.Master" AutoEventWireup="true" CodeBehind="BorrowCardLost.aspx.cs" Inherits="Web.main.BorrowCardLost" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
        ...
        <ItemTemplate>
            <asp:Panel ID="plItem" runat="server">
                ...
                <tr>
                    <td>
                        <asp:LinkButton ID="lbtLost" CommandName="Lose" CommandArgument='<%#Eval("cardid") %>' runat="server">挂失</asp:LinkButton>
                        <asp:LinkButton ID="lbtFind" CommandName="Find" CommandArgument='<%#Eval("cardid") %>' runat="server">解挂</asp:LinkButton>
                    </td>
                    <td><%#Eval("lose").ToString()=="True"?"<span style='color:green'>正常</span>":"<span style='color:red'>挂失</span>" %></td>
